  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24 sm:pt-28 pb-16 px-4 sm:px-6 lg:px-12 max-w-4xl mx-auto">
        <h1 className="font-display text-2xl sm:text-3xl lg:text-4xl font-bold mb-8">Política DMCA</h1>
        
        <div className="space-y-6 text-sm sm:text-base text-muted-foreground leading-relaxed">
          <section>
            <h2 className="font-display text-lg sm:text-xl font-semibold text-foreground mb-3">1. Introdução</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-lg sm:text-xl font-semibold text-foreground mb-3">2. Isenção de Responsabilidade</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-lg sm:text-xl font-semibold text-foreground mb-3">3. Notificação de Violação</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-lg sm:text-xl font-semibold text-foreground mb-3">4. Remoção de Conteúdo</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-lg sm:text-xl font-semibold text-foreground mb-3">5. Reincidência</h2>
            <p>
